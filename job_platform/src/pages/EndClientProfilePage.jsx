...
export default function EndClientProfilePage() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    companyName: localStorage.getItem('companyName') || 'TechCorp Inc.',
    companyDescription: 'Leading technology company specializing in innovative solutions',
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 bg-orange-50 rounded-xl border-2 border-orange-200">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <p className="text-sm text-orange-700">Joined Date</p>
                          <p className="text-xl font-bold text-orange-900">Jan 15, 2024</p>
                        </div>
                      </div>
                      <p className="text-sm text-orange-700">Member for 11 months</p>
                    </div>
                  </div>
                </motion.div>
              )}
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={handleSave}
                      className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl font-semibold shadow-lg"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      ...
                      <div className="p-6 bg-green-50 rounded-xl text-center">
                        <p className="text-3xl font-bold text-green-600 mb-1">186</p>
                        <p className="text-sm text-gray-600">Total Applications</p>
                      </div>
                      <div className="p-6 bg-purple-50 rounded-xl text-center">
                        <p className="text-3xl font-bold text-purple-600 mb-1">38</p>
